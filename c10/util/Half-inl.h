...
// including this stanza seemed like good hygiene, but it ends up messing
// with the compiler's ability to figure out what the execution mode is below
#if 0
#ifndef __NOT_CPU__
...
#elif defined(NATIVE_FP16)
      y(value)
#else // !NATIVE_FP16 && !AVX && !SYCL && !CUDA && !ROCM
