...
REGISTER_SVE256_DISPATCH(dequantize_tensor_per_tensor_affine_stub,
                  &dequantize_tensor_per_tensor_affine_cpu);
REGISTER_SVE256_DISPATCH(fake_quant_grad_learnable_tensor_stub,
                  &fake_quantize_learnable_tensor_grad_kernel_cpu);
REGISTER_SVE256_DISPATCH(fake_quant_tensor_cachemask_stub,
                  &fake_quantize_tensor_cachemask_kernel);
REGISTER_SVE256_DISPATCH(fake_quant_tensor_cachemask_tensor_qparams_stub,
                  &fake_quantize_tensor_cachemask_tensor_qparams_kernel);
REGISTER_SVE256_DISPATCH(qadaptive_avg_pool2d_nhwc_stub,
                  &qadaptive_avg_pool2d_nhwc_kernel);
REGISTER_SVE256_DISPATCH(qadaptive_avg_pool3d_ndhwc_stub,
                  &qadaptive_avg_pool3d_ndhwc_kernel);
REGISTER_SVE256_DISPATCH(qadd_relu_stub, &qadd_kernel<true>);
REGISTER_SVE256_DISPATCH(qadd_scalar_relu_stub, &qadd_scalar_kernel<true>);
REGISTER_SVE256_DISPATCH(qadd_scalar_stub, &qadd_scalar_kernel<false>);
REGISTER_SVE256_DISPATCH(qadd_stub, &qadd_kernel<false>);

REGISTER_SVE256_DISPATCH(qbatch_norm_relu_stub, &q_batch_norm_kernel<true>);
REGISTER_SVE256_DISPATCH(qbatch_norm_stub, &q_batch_norm_kernel<false>);
REGISTER_SVE256_DISPATCH(qcat_nhwc_stub, &qcat_nhwc_kernel<false>);
REGISTER_SVE256_DISPATCH(qcat_relu_nhwc_stub, &qcat_nhwc_kernel<true>);
REGISTER_SVE256_DISPATCH(qclamp_stub, &qclamp_kernel);
REGISTER_SVE256_DISPATCH(qclamp_min_stub, &qclamp_min_kernel);
REGISTER_SVE256_DISPATCH(qclamp_max_stub, &qclamp_max_kernel);
REGISTER_SVE256_DISPATCH(qelu_stub, &qelu_kernel);
REGISTER_SVE256_DISPATCH(qhardsigmoid_stub, &qhardsigmoid_kernel);
REGISTER_SVE256_DISPATCH(qhardswish_stub, &qhardswish_kernel);
REGISTER_SVE256_DISPATCH(qmaxpool_2d_nhwc_stub, &qmaxpool_2d_nhwc_kernel);
REGISTER_SVE256_DISPATCH(qmaxpool_3d_nthwc_stub, &qmaxpool_3d_nthwc_kernel);
REGISTER_SVE256_DISPATCH(qmul_relu_stub, &qmul_kernel<true>);
REGISTER_SVE256_DISPATCH(qmul_stub, &qmul_kernel<false>);
REGISTER_SVE256_DISPATCH(qrelu_leaky_stub, &leaky_qrelu_out_kernel);
REGISTER_SVE256_DISPATCH(qrelu_stub, &qrelu_kernel);
REGISTER_SVE256_DISPATCH(qprelu_stub, &qprelu_out_kernel);
REGISTER_SVE256_DISPATCH(qgelu_stub, &qgelu_kernel);
REGISTER_SVE256_DISPATCH(qsigmoid_stub, &qsigmoid_kernel);
REGISTER_SVE256_DISPATCH(qtanh_stub, &qtanh_kernel);
REGISTER_SVE256_DISPATCH(qthreshold_stub, &qthreshold_kernel);
REGISTER_SVE256_DISPATCH(qtopk_stub, &qtopk_kernel);
REGISTER_SVE256_DISPATCH(fake_quant_grad_learnable_channel_stub,
...
REGISTER_SVE256_DISPATCH(quantized_normalize_stub, &quantized_normalize_kernel);
REGISTER_SVE256_DISPATCH(quantized_groupnorm_nhwc_stub, &quantized_groupnorm_nhwc_kernel);
REGISTER_SVE256_DISPATCH(qupsample_bilinear2d_nhwc_stub,
...
REGISTER_SVE256_DISPATCH(qmean_inner_dim_stub, &qmean_inner_dim_kernel);
REGISTER_SVE256_DISPATCH(qstd_inner_dim_stub, &qstd_inner_dim_kernel);
#else
